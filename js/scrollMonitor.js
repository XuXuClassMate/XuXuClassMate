!function (t, e) {
    ...
    return function (t) {
        ...
        "use strict";
        var o = i(1), s = o.isInBrowser, n = i(2), r = new n(s ? document.body : null);
        ...
        var h = i(1), c = h.isOnServer, a = h.isInBrowser, l = h.eventTypes, p = i(3), w = function () {
            function t(e, i) {
                function h() {
            ...
            return t.prototype.listenToDOM = function () {
                ...
                var e = r(this.item), i = s(this.item), o = n(this.item);
        ...
        var s = i(1), n = s.VISIBILITYCHANGE, r = s.ENTERVIEWPORT, h = s.FULLYENTERVIEWPORT, c = s.EXITVIEWPORT,
            a = s.PARTIALLYEXITVIEWPORT, l = s.LOCATIONCHANGE, p = s.STATECHANGE, w = s.eventTypes,
            u = s.defaultOffsets;
        o.prototype = {
            on: function (t, e, i) {
                switch (!0) {
                ...
                var t = this.container.watchers.indexOf(this), e = this;
...
sourceMappingURL = scrollMonitor.js